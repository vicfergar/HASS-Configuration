...
class ESP8266SoftwareSerial {
 ...
 protected:
  ...
  void wait_(unsigned long *deadline);
  bool read_bit_(unsigned long *deadline);
  void write_bit_(bool bit, unsigned long *deadline);

  unsigned long bit_time_{0};
  ...
  //esp8266::ESP8266GPIOPin *gpio_test_pin_{nullptr};
};
